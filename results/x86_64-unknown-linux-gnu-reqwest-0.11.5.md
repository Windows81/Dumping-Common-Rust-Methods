## `[0x55c1464198d0]` `reqwest::get::<String>` `0.11.27`
...
## `[0x55c1464198f0]` `reqwest::get::<&'static String>` `0.11.27`
...
## `[0x55c146419910]` `reqwest::get::<&'static str>` `0.11.27`
     1. result(s) matching first 0x07 bytes
     2. result(s) matching first 0x06 bytes
    10. result(s) matching first 0x05 bytes
    49. result(s) matching first 0x04 bytes
...
## `[0x55c146419890]` `reqwest::get::<url::Url>` `0.11.27`
     1. result(s) matching first 0x07 bytes
     2. result(s) matching first 0x06 bytes
    10. result(s) matching first 0x05 bytes
    49. result(s) matching first 0x04 bytes
...
## `[0x55c146419be0]` `reqwest::Client::request::<String>` `0.11.27`
...
## `[0x55c146419e90]` `reqwest::Client::request::<&'static String>` `0.11.27`
     1. result(s) matching first 0x25 bytes
     3. result(s) matching first 0x23 bytes
     4. result(s) matching first 0x0F bytes
     5. result(s) matching first 0x0E bytes
...
## `[0x55c14641a140]` `reqwest::Client::request::<&'static str>` `0.11.27`
...
## `[0x55c146419930]` `reqwest::Client::request::<url::Url>` `0.11.27`
     1. result(s) matching first 0x25 bytes
     3. result(s) matching first 0x23 bytes
     4. result(s) matching first 0x0F bytes
     5. result(s) matching first 0x0E bytes
